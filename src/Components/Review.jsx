...
const Review = () => {
    return (
        <section className="dark:bg-gray-200">
                ...
                <div className="grid items-center gap-4 xl:grid-cols-5">
                    ...
                    <div className="p-6 xl:col-span-3">
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="p-6 rounded shadow-md bg-blue-200 text-black">
                            ...
                            <div className="p-6 rounded shadow-md bg-green-200 text-black">
